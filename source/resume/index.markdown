...
精通软件系统架构方法、过程和相关技术。熟悉互联网、大数据、云等情形下软件系统架构特点和应用策略。  深入理解软件开发过程。熟悉Java相关技术。  善于沟通合作，具备相当的领导力和辅导培训能力。
...
* 2015 /12--至今：客如云科技（成都）有限公司
  * 技术和架构群
  * 应用架构负责人
  * 负责公司软件系统应用架构工作。并负责方案架构和业务层数据架构。制定跟进公司级应用架构原则与演进方向。发起和完成重大架构重构任务。领导和完成重点、难点需求的方案设计任务。设计和执行公司级架构管理机制。
...
* 2017 /9--2017 /12：客如云分区部署项目
  * 项目描述：将客如云系统进行分区部署，第一期达成稳定区、体验区分区。后续实现按地域分区和大客户单独分区。
  * 责任描述：主要参与人、架构设计。

----

* 2017 /1--2017 /9：客如云SaaS系统物理分库系列项目
  * 项目描述：将客如云数据库物理上从一个单一数据库分为按领域分布的多个数据库。
