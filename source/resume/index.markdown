...
有长期的架构设计和执行经验。并有全局级别的架构设计、演进和管理经验。精通软件架构方法、过程和相关技术。熟悉互联网、大数据、云等情形下软件系统架构特点和应用策略。深入理解软件开发过程，熟悉敏捷过程，对敏捷环境下的架构过程有经验。熟悉Java相关技术。善于任务管理、沟通协作，具备相当的领导力和辅导培训能力。
...
### <a name="2"></a>工作经验
* 2018 /9 -- 至今：四川驹马科技有限公司
  * 研发部
  * 总架构师
  * 负责公司所有软件系统的全部架构工作。包括架构设计、架构执行、架构管理、架构演进。
* 2015 /12--2018 /8：客如云科技（成都）有限公司
  * 技术和架构群
  * 应用架构负责人
  * 负责公司软件系统应用架构工作。并负责方案架构和业务层数据架构。制定执行公司全局级应用架构原则与演进方向。发起和完成重大架构重构任务。领导和完成重点、难点需求的方案设计任务。设计和执行公司级架构管理机制。
...
* 2001 /7--2004 /6z：Erry（异联）科技（上海）有限公司
  * 项目实施部
  * Software Developer
  * j2ee软件设计和开发
...
* 2018 /1--2018 /8：客如云PaaS化项目
  * 项目描述：旨在使客如云系统能快速切入多业态的软件平台化项目。
  * 责任描述：主要参与人、架构设计

----


* 2017 /9-- 2018 /8：客如云DDD导入实践项目

  * 项目描述：在客如云开发团队中导入DDD风格的开发过程，实践DDD相关模式的项目。
  * 责任描述：发起人、负责人、培训师
  * 相关博客：

    * [领域驱动设计](http://www.nietongxue.xyz/blog/filter/filter.html?filterName=series&filterValue=领域驱动设计&filterDes=Series%3A%20领域驱动设计)

----

* 2017 /9--2017 /12：客如云分区部署项目
  * 项目描述：将客如云系统进行分区部署的全局项目，第一期达成稳定区、体验区分区。后续实现按地域分区和大客户单独分区。
  * 责任描述：主要参与人、架构设计。

----

* 2017 /1--2017 /9：客如云SaaS系统物理分库系列项目
  * 项目描述：将客如云业务数据库物理上从一个单一数据库分为按领域布置的多个数据库的全局项目。
  * 责任描述：发起人、负责人、架构设计、架构执行。

---

* 2015 /12--2017 /1：客如云SaaS系统领域化项目
  * 项目描述：以领域为单位解耦全系统，并将有界上下文模式引入，相应调整团队职能和开发过程的全局项目。
  * 责任描述：发起人、负责人、架构设计、架构执行。
  * 相关博客：
